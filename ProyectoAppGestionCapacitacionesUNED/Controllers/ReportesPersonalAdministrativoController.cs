...
namespace ProyectoAppGestionCapacitacionesUNED.Controllers
{
    ...
    public class ReportesPersonalAdministrativoController : Controller
    {
        private readonly ApplicationDbContext _db;

        public ReportesPersonalAdministrativoController(ApplicationDbContext db)
        {
            _db = db;
        }
        ...
        {
            var reportenull = Enumerable.Empty<AsistenciaPersonalAdministrativo>().AsQueryable();
        ...
        public IActionResult ReporteAsistencia(string searchCode)
        {
            ...
            var reportenull = Enumerable.Empty<AsistenciaPersonalAdministrativo>().AsQueryable();
            if (_db.CapacitacionPersonalAdministrativos.Any(c => c.Codigo == searchCode))
            {
                var cod = _db.CapacitacionPersonalAdministrativos.SingleOrDefault(c => c.Codigo == searchCode);
                var id = cod.Id;
                if (_db.AsistenciaPersonalAdministrativos.Any(c => c.CapacitacionPersonalAdministrativoID == id))
                {
                    var reporte = _db.AsistenciaPersonalAdministrativos.Include(m => m.CapacitacionPersonalAdministrativo).Include(m => m.RegistroPersonalAdministrativo).Where(m => m.CapacitacionPersonalAdministrativoID == id).Where(m => m.Asistencia == true).ToList();
        ...
        public IActionResult ReporteAsistenciaPersonalAdministrativoPartial(string searchCode)
        {
            var reportenull = Enumerable.Empty<AsistenciaPersonalAdministrativo>().AsQueryable();
            if (_db.CapacitacionPersonalAdministrativos.Any(c => c.Codigo == searchCode))
            {
        ...
        public IActionResult ReporteAsistenciaPersonalAdministrativo(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAdministrativos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.AsistenciaPersonalAdministrativos.Include(m => m.CapacitacionPersonalAdministrativo).Include(m => m.RegistroPersonalAdministrativo).Where(m => m.CapacitacionPersonalAdministrativoID == id).Where(m => m.Asistencia == true).ToList();

            return new ViewAsPdf("ReporteAsistenciaPersonalAdministrativoPartial", reporte)
            {
        ...
        {
            var reporte = Enumerable.Empty<AsistenciaPersonalAdministrativo>().AsQueryable().ToList();
            return View(reporte);
        }
        ...
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<AsistenciaPersonalAdministrativo>().AsQueryable().ToList();
            if (_db.CapacitacionPersonalAdministrativos.Any(c => c.Codigo == searchCode))
            {
                var cod = _db.CapacitacionPersonalAdministrativos.SingleOrDefault(c => c.Codigo == searchCode);
                var id = cod.Id;
        ...
        public IActionResult ReporteGeneroPersonalAdministrativoPartial(string searchCode)
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<AsistenciaPersonalAdministrativo>().AsQueryable();
            if (_db.CapacitacionPersonalAdministrativos.Any(c => c.Codigo == searchCode))
        ...
        public IActionResult ReporteGeneroPersonalAdministrativo(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAdministrativos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.AsistenciaPersonalAdministrativos.Include(m => m.CapacitacionPersonalAdministrativo).Include(m => m.RegistroPersonalAdministrativo).Where(m => m.CapacitacionPersonalAdministrativoID == id).Where(m => m.Asistencia == true).ToList();

            return new ViewAsPdf("ReporteGeneroPersonalAdministrativoPartial", reporte)
            {
                PageSize = Rotativa.AspNetCore.Options.Size.A4
        ...
        public IActionResult ReporteDependencia()
        {
            var reporte = Enumerable.Empty<AsistenciaPersonalAdministrativo>().AsQueryable().ToList();
            return View(reporte);
        }
        ...
        [HttpPost]
        public IActionResult ReporteDependencia(string searchCode)
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<AsistenciaPersonalAdministrativo>().AsQueryable().ToList();
            if (_db.CapacitacionPersonalAdministrativos.Any(c => c.Codigo == searchCode))
        ...
        public IActionResult ReporteDependenciaPersonalAdministrativoPartial(string searchCode)
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<AsistenciaPersonalAdministrativo>().AsQueryable().ToList();
            if (_db.CapacitacionPersonalAdministrativos.Any(c => c.Codigo == searchCode))
        ...
        public IActionResult ReporteDependenciaPersonalAdministrativo(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAdministrativos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.AsistenciaPersonalAdministrativos.Include(m => m.CapacitacionPersonalAdministrativo).Include(m => m.RegistroPersonalAdministrativo).Where(m => m.CapacitacionPersonalAdministrativoID == id).Where(m => m.Asistencia == true).ToList();

            return new ViewAsPdf("ReporteDependenciaPersonalAdministrativoPartial", reporte)
            {
                PageSize = Rotativa.AspNetCore.Options.Size.A4
        ...
        public IActionResult ReporteGradoAcademicoPersonalAdministrativoPartial(string searchCode)
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<AsistenciaPersonalAdministrativo>().AsQueryable().ToList();
            if (_db.CapacitacionPersonalAdministrativos.Any(c => c.Codigo == searchCode))
        ...
        public IActionResult ReporteGradoAcademicoPersonalAdministrativo(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAdministrativos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.AsistenciaPersonalAdministrativos.Include(m => m.CapacitacionPersonalAdministrativo).Include(m => m.RegistroPersonalAdministrativo).Where(m => m.CapacitacionPersonalAdministrativoID == id).Where(m => m.Asistencia == true).ToList();

            return new ViewAsPdf("ReporteGradoAcademicoPersonalAdministrativoPartial", reporte)
            {
                PageSize = Rotativa.AspNetCore.Options.Size.A4
        ...
        {
            var reporte = Enumerable.Empty<AsistenciaPersonalAcademico>().AsQueryable();
            return View();
        }
            ...
            if (_db.CapacitacionPersonalAdministrativos.Any(c => c.Codigo == searchCode))
            {
                ...
                if (_db.AsistenciaPersonalAdministrativos.Any(c => c.CapacitacionPersonalAdministrativoID == id))
                {
                    if (_db.EncuestaPersonalAdministrativos.Any(c => c.CapacitacionPersonalAdministrativoID == id))
                    {
                        ...
                        var nombre = reporte.First().CapacitacionPersonalAdministrativo.NombreCapacitacion;
                        var codigo = reporte.First().CapacitacionPersonalAdministrativo.Codigo;
                        var instructor = reporte.First().CapacitacionPersonalAdministrativo.NombreInstructor;
                        var fecha = reporte.First().CapacitacionPersonalAdministrativo.FechaCapacitacion;
                        ...
                        try
                        {
                            var encuesta = _db.EncuestaPersonalAdministrativos.Where(c => c.CapacitacionPersonalAdministrativoID == id).ToList();
        ...
        public IActionResult ReporteGradoSatisfaccionPersonalAdministrativoPartial(string searchCode)
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<AsistenciaPersonalAdministrativo>().AsQueryable().ToList();
            if (_db.CapacitacionPersonalAdministrativos.Any(c => c.Codigo == searchCode))
            {
                ...
                if (_db.AsistenciaPersonalAdministrativos.Any(c => c.CapacitacionPersonalAdministrativoID == id))
                {
                    if (_db.EncuestaPersonalAdministrativos.Any(c => c.CapacitacionPersonalAdministrativoID == id))
                    {
                        var reporte = _db.EncuestaPersonalAdministrativos.Include(m => m.CapacitacionPersonalAdministrativo).Where(m => m.CapacitacionPersonalAdministrativoID == id).ToList();
        ...
        public IActionResult ReporteGradoSatisfaccionPersonalAdministrativo(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAdministrativos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.EncuestaPersonalAdministrativos.Include(m => m.CapacitacionPersonalAdministrativo).Where(m => m.CapacitacionPersonalAdministrativoID == id).ToList();

            return new ViewAsPdf("ReporteGradoSatisfaccionPersonalAdministrativoPartial", reporte)
            {
                PageSize = Rotativa.AspNetCore.Options.Size.A4
        ...
        {
            var reporte = Enumerable.Empty<EncuestaPersonalAdministrativo>().AsQueryable().ToList();
            return View(reporte);
        }
        ...
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<EncuestaPersonalAdministrativo>().AsQueryable().ToList();
            if (_db.CapacitacionPersonalAdministrativos.Any(c => c.Codigo == searchCode))
            {
                var cod = _db.CapacitacionPersonalAdministrativos.SingleOrDefault(c => c.Codigo == searchCode);
                var id = cod.Id;
                if (_db.EncuestaPersonalAdministrativos.Any(c => c.CapacitacionPersonalAdministrativoID == id))
                {
                    var reporte = _db.EncuestaPersonalAdministrativos.Where(m => m.CapacitacionPersonalAdministrativoID == id).ToList();
        ...
        public IActionResult ReporteSugerenciasPersonalAdministrativoPartial(string searchCode)
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<EncuestaPersonalAdministrativo>().AsQueryable();
            if (_db.CapacitacionPersonalAdministrativos.Any(c => c.Codigo == searchCode))
            {
                var cod = _db.CapacitacionPersonalAdministrativos.SingleOrDefault(c => c.Codigo == searchCode);
                var id = cod.Id;
        ...
        public IActionResult ReporteSugerenciasPersonalAdministrativo(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAdministrativos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.EncuestaPersonalAdministrativos.Include(m => m.CapacitacionPersonalAdministrativo).Where(m => m.CapacitacionPersonalAdministrativoID == id).ToList();

            return new ViewAsPdf("ReporteSugerenciasPersonalAdministrativoPartial", reporte)
            {
                PageSize = Rotativa.AspNetCore.Options.Size.A4
