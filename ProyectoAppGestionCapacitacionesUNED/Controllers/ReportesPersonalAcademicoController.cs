...
namespace ProyectoAppGestionCapacitacionesUNED.Controllers
{
    ...
    public class ReportesPersonalAcademicoController : Controller
    {
        private readonly ApplicationDbContext _db;

        public ReportesPersonalAcademicoController(ApplicationDbContext db)
        {
            _db = db;
        }
        ...
        {
            var reportenull = Enumerable.Empty<AsistenciaPersonalAcademico>().AsQueryable();
        ...
        public IActionResult ReporteAsistencia(string searchCode)
        {
            ...
            var reportenull = Enumerable.Empty<AsistenciaPersonalAcademico>().AsQueryable();
            if (_db.CapacitacionPersonalAcademicos.Any(c => c.Codigo == searchCode))
            {
                var cod = _db.CapacitacionPersonalAcademicos.SingleOrDefault(c => c.Codigo == searchCode);
                var id = cod.Id;
                if (_db.AsistenciaPersonalAcademicos.Any(c => c.CapacitacionPersonalAcademicoID == id))
                {
                    var reporte = _db.AsistenciaPersonalAcademicos.Include(m => m.CapacitacionPersonalAcademico).Include(m => m.RegistroPersonalAcademico).Where(m => m.CapacitacionPersonalAcademicoID == id).Where(m => m.Asistencia == true).ToList();
        ...
        public IActionResult ReporteAsistenciaPersonalAcademicoPartial(string searchCode)
        {
            var reportenull = Enumerable.Empty<AsistenciaPersonalAcademico>().AsQueryable();
            if (_db.CapacitacionPersonalAcademicos.Any(c => c.Codigo == searchCode))
            {
        ...
        public IActionResult ReporteAsistenciaPersonalAcademico(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAcademicos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.AsistenciaPersonalAcademicos.Include(m => m.CapacitacionPersonalAcademico).Include(m => m.RegistroPersonalAcademico).Where(m => m.CapacitacionPersonalAcademicoID == id).Where(m => m.Asistencia == true).ToList();

            return new ViewAsPdf("ReporteAsistenciaPersonalAcademicoPartial", reporte)
            {
        ...
        {
            var reporte = Enumerable.Empty<AsistenciaPersonalAcademico>().AsQueryable().ToList();
            return View(reporte);
        }
        ...
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<AsistenciaPersonalAcademico>().AsQueryable().ToList();
            if (_db.CapacitacionPersonalAcademicos.Any(c => c.Codigo == searchCode))
            {
                var cod = _db.CapacitacionPersonalAcademicos.SingleOrDefault(c => c.Codigo == searchCode);
                var id = cod.Id;
        ...
        public IActionResult ReporteGeneroPersonalAcademicoPartial(string searchCode)
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<AsistenciaPersonalAcademico>().AsQueryable();
            if (_db.CapacitacionPersonalAcademicos.Any(c => c.Codigo == searchCode))
        ...
        public IActionResult ReporteGeneroPersonalAcademico(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAcademicos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.AsistenciaPersonalAcademicos.Include(m => m.CapacitacionPersonalAcademico).Include(m => m.RegistroPersonalAcademico).Where(m => m.CapacitacionPersonalAcademicoID == id).Where(m => m.Asistencia == true).ToList();

            return new ViewAsPdf("ReporteGeneroPersonalAcademicoPartial", reporte)
            {
                PageSize = Rotativa.AspNetCore.Options.Size.A4
        ...
        public IActionResult ReporteDependenciaPersonalAcademicoPartial(string searchCode)
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<AsistenciaPersonalAcademico>().AsQueryable().ToList();
            if (_db.CapacitacionPersonalAcademicos.Any(c => c.Codigo == searchCode))
        ...
        public IActionResult ReporteDependenciaPersonalAcademico(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAcademicos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.AsistenciaPersonalAcademicos.Include(m => m.CapacitacionPersonalAcademico).Include(m => m.RegistroPersonalAcademico).Where(m => m.CapacitacionPersonalAcademicoID == id).Where(m => m.Asistencia == true).ToList();

            return new ViewAsPdf("ReporteDependenciaPersonalAcademicoPartial", reporte)
            {
                PageSize = Rotativa.AspNetCore.Options.Size.A4
        ...
        public IActionResult ReporteGradoAcademicoPersonalAcademicoPartial(string searchCode)
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<AsistenciaPersonalAcademico>().AsQueryable().ToList();
            if (_db.CapacitacionPersonalAcademicos.Any(c => c.Codigo == searchCode))
        ...
        public IActionResult ReporteGradoAcademicoPersonalAcademico(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAcademicos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.AsistenciaPersonalAcademicos.Include(m => m.CapacitacionPersonalAcademico).Include(m => m.RegistroPersonalAcademico).Where(m => m.CapacitacionPersonalAcademicoID == id).Where(m => m.Asistencia == true).ToList();

            return new ViewAsPdf("ReporteGradoAcademicoPersonalAcademicoPartial", reporte)
            {
                PageSize = Rotativa.AspNetCore.Options.Size.A4
            ...
            if (_db.CapacitacionPersonalAcademicos.Any(c => c.Codigo == searchCode))
            {
                ...
                if (_db.AsistenciaPersonalAcademicos.Any(c => c.CapacitacionPersonalAcademicoID == id))
                {
                    if (_db.EncuestaPersonalAcademicos.Any(c => c.CapacitacionPersonalAcademicoID == id))
                    {
                        ...
                        var nombre = reporte.First().CapacitacionPersonalAcademico.NombreCapacitacion;
                        var codigo = reporte.First().CapacitacionPersonalAcademico.Codigo;
                        var instructor = reporte.First().CapacitacionPersonalAcademico.NombreInstructor;
                        var fecha = reporte.First().CapacitacionPersonalAcademico.FechaCapacitacion;
                        ...
                        try
                        {
                            var encuesta = _db.EncuestaPersonalAcademicos.Where(c => c.CapacitacionPersonalAcademicoID == id).ToList();
        ...
        public IActionResult ReporteGradoSatisfaccionPersonalAcademicoPartial(string searchCode)
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<AsistenciaPersonalAcademico>().AsQueryable().ToList();
            if (_db.CapacitacionPersonalAcademicos.Any(c => c.Codigo == searchCode))
            {
                ...
                if (_db.AsistenciaPersonalAcademicos.Any(c => c.CapacitacionPersonalAcademicoID == id))
                {
                    if (_db.EncuestaPersonalAcademicos.Any(c => c.CapacitacionPersonalAcademicoID == id))
                    {
                        var reporte = _db.EncuestaPersonalAcademicos.Include(m => m.CapacitacionPersonalAcademico).Where(m => m.CapacitacionPersonalAcademicoID == id).ToList();
        ...
        public IActionResult ReporteGradoSatisfaccionPersonalAcademico(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAcademicos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.EncuestaPersonalAcademicos.Include(m => m.CapacitacionPersonalAcademico).Where(m => m.CapacitacionPersonalAcademicoID == id).ToList();

            return new ViewAsPdf("ReporteGradoSatisfaccionPersonalAcademicoPartial", reporte)
            {
                PageSize = Rotativa.AspNetCore.Options.Size.A4
        ...
        {
            var reporte = Enumerable.Empty<EncuestaPersonalAcademico>().AsQueryable().ToList();
            return View(reporte);
        }
        ...
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<EncuestaPersonalAcademico>().AsQueryable().ToList();
            if (_db.CapacitacionPersonalAcademicos.Any(c => c.Codigo == searchCode))
            {
                var cod = _db.CapacitacionPersonalAcademicos.SingleOrDefault(c => c.Codigo == searchCode);
                var id = cod.Id;
                if (_db.EncuestaPersonalAcademicos.Any(c => c.CapacitacionPersonalAcademicoID == id))
                {
                    var reporte = _db.EncuestaPersonalAcademicos.Where(m => m.CapacitacionPersonalAcademicoID == id).ToList();
        ...
        public IActionResult ReporteSugerenciasPersonalAcademicoPartial(string searchCode)
        {
            ViewBag.CurrentFilter = searchCode;
            var reportenull = Enumerable.Empty<EncuestaPersonalAcademico>().AsQueryable();
            if (_db.CapacitacionPersonalAcademicos.Any(c => c.Codigo == searchCode))
            {
                var cod = _db.CapacitacionPersonalAcademicos.SingleOrDefault(c => c.Codigo == searchCode);
                var id = cod.Id;
        ...
        public IActionResult ReporteSugerenciasPersonalAcademico(string searchCode)
        {
            var cod = _db.CapacitacionPersonalAcademicos.SingleOrDefault(c => c.Codigo == searchCode);
            var id = cod.Id;
            var reporte = _db.EncuestaPersonalAcademicos.Include(m => m.CapacitacionPersonalAcademico).Where(m => m.CapacitacionPersonalAcademicoID == id).ToList();

            return new ViewAsPdf("ReporteSugerenciasPersonalAcademicoPartial", reporte)
            {
                PageSize = Rotativa.AspNetCore.Options.Size.A4
